...
{
    /// <inheritdoc />
    public partial class addRealationBetweenApplicationUserandNotesandTasksAndCourses : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserCourses", x => new { x.UserId, x.CourseId });
                    table.ForeignKey(
